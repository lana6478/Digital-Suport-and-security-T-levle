...
| Specialism | Leads toward | Content area 1 | Content area 2 | Content area 3 |
|---|---|---|---|---|
| **Digital Infrastructure** | Infrastructure technician | Apply procedures and controls to maintain digital security | Explain, install, configure, test and manage both physical and virtual infrastructure | Discover, evaluate and apply reliable sources of knowledge |
| **Network Cabling** | Network cable installer | Apply procedures and controls to maintain digital security | Install and test cabling in line with technical and security requirements | Discover, evaluate and apply reliable sources of knowledge |
| **Digital Support** | Digital support technician | Apply procedures and controls to maintain digital security | Install, configure and support software applications and operating systems | Discover, evaluate and apply reliable sources of knowledge |
| **Cyber Security** | Cyber security technician | Apply procedures and controls to maintain digital security | Propose remediation advice for a security risk assessment | Discover, evaluate and apply reliable sources of knowledge |

Each specialism is assessed by a single externally-set, synoptic project (see [Scheme of Assessment](05-scheme-of-assessment.md)) and aligns to a specific Level 3 Apprenticeship standard, giving students a direct route into employment or further training in that occupational area.
