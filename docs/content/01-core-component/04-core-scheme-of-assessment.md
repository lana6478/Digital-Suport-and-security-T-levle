...
| | |
|---|---|
| Format | Written examination, 2 hours 15 minutes |
| Weighting | 30% of the core |
| Marks | 90 |
...
| Weighting | 30% of the core |
| Marks | 90 |
| Content | 4. Legislation and regulatory requirements · 5. Business context · 6. Emerging issues · 7. Digital environments · 8. Security |

Same format as Paper 1: two sections (A and B), progressively harder, short/medium/extended open-response questions, set and marked by Pearson under JCQ ICE conditions.

## Core Examination Assessment Objectives

Both papers are marked against the same five Assessment Objectives, just weighted slightly differently:

| AO | Description | Paper 1 (marks/%) | Paper 2 (marks/%) |
|---|---|---|---|
| AO1a | Demonstrate knowledge and understanding of the content *(knowledge)* | 8 (8.9%) | 10 (11.1%) |
| AO1b | Demonstrate knowledge and understanding of the content *(understanding)* | 22 (24.4%) | 21 (23.3%) |
| AO2 | Apply knowledge and understanding to different situations and contexts | 39 (43.3%) | 38 (42.2%) |
...
| | |
|---|---|
| Format | Externally assessed project, 14 hours 30 minutes (across multiple sessions) |
| Weighting | 40% of the core |
| Marks | 89–100 |
...
The three ESP pathways share the same five AOs, but weight them differently.

**Digital Support and Digital Infrastructure & Network Cabling ESPs:**

| AO | Focus | What it assesses | Weighting |
|---|---|---|---|
| AO1 | Planning | Plan an approach to developing solutions in response to a brief | 12% |
| AO2 | Application | Apply knowledge/skills to develop software, create an artefact, fix defects, mitigate security risks | 41% |
| AO3 | Selecting relevant techniques and resources | Select relevant tools/techniques/resources and work collaboratively | 9% |
| AO4a–c | English / maths / digital skills | Communicate technical information appropriately; use maths and digital skills to realise the project outcome | 3% |
| AO5d | Project outcome | Realise a project outcome by producing software/artefacts in response to a brief | 26% |
| AO5e | Review | Reflectively evaluate how well the solution meets the brief | 9% |
...
|---|---|---|
| AO1 | Planning | 13.5% |
| AO2 | Application | 49.4% |
| AO3 | Selecting relevant techniques and resources | 10.1% |
| AO4a–c | English / maths / digital skills | 3.4% |
...
- [Employer Set Projects](03-employer-set-projects.md)
- [Core Paper 1](01-core-paper-1.md)
- [Core Paper 2](02-core-paper-2.md)
- [Grading and results](../00-overview/04-grading-and-results.md)
